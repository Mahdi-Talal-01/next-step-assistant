...
describe("Skill Request Validators", () => {
  ...
  describe("validateRoadmapSkill", () => {
    it("should pass validation with valid roadmap skill data", () => {
      // Setup
      req.body = {
        skillId: "123e4567-e89b-12d3-a456-426614174000",
        level: 3,
      ...
      // Call the validator
      validateRoadmapSkill(req, res, next);
  ...
  describe("validateTopicSkill", () => {
    it("should pass validation with valid topic skill data", () => {
      // Setup
      req.body = {
        skillId: "123e4567-e89b-12d3-a456-426614174000",
        level: 3,
      ...
      // Call the validator
      validateTopicSkill(req, res, next);
    ...
    it("should fail validation when skillId is missing", () => {
      // Setup
      req.body = {
        level: 3,
      };
