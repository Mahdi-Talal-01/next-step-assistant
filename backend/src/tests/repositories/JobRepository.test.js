...
describe("JobRepository", () => {
  ...
  describe("createJob", () => {
    ...
    it("should throw an error if job creation fails", async () => {
      ...
      await expect(JobRepository.createJob(userId, jobData)).rejects.toThrow(
        error
      );
    });
  });
  describe("getJobsByUserId", () => {
    ...
    it("should throw an error if fetching jobs fails", async () => {
      ...
      // Call and assert
      await expect(JobRepository.getJobsByUserId(userId)).rejects.toThrow(
        error
      );
    });
  });
  describe("getJobById", () => {
    ...
    it("should throw an error if fetching job fails", async () => {
      ...
      // Call and assert
      await expect(JobRepository.getJobById(jobId, userId)).rejects.toThrow(
        error
      );
    });
  });
